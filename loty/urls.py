...
from .views import lot, lot_detail, lot_delete, dodaj_lot, modyfikuj_lot, index, pagination, usun_lot
from . import views
...
urlpatterns = [
        ...
        path(" modyfikuj_lot ", views.PostListView2.as_view(), name= "modyfikuj_lot"),
